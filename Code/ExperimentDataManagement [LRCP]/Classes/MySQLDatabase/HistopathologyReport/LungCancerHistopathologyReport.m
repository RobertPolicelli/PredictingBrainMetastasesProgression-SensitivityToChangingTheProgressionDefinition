classdef LungCancerHistopathologyReport <  MalignantHistopathologyReport
    ...
    methods (Access = public)
        ...
        function ePDL1Status = GetPDL1Status(obj)
            ePDL1Status = obj.ePDL1Status;
        end
        
        function eALKStatus = GetALKStatus(obj)
            eALKStatus = obj.eALKStatus;
        end
        
        function eEGFRStatus = GetEGFRStatus(obj)
            eEGFRStatus = obj.eEGFRStatus;
        end
        
        function eROS1Status = GetROS1Status(obj)
            eROS1Status = obj.eROS1Status;
        end
        
        function eBRAFStatus = GetBRAFStatus(obj)
            eBRAFStatus = obj.eBRAFStatus;
        end
        
        function eKRASStatus = GetKRASStatus(obj)
            eKRASStatus = obj.eKRASStatus;
        end
    end

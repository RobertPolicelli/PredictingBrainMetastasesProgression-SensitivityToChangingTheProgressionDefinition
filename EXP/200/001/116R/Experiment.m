classdef Experiment < handle
    ...
    methods (Access = private)
        ...
        function [sCompletedExperimentPath, bErrored] = RunMain(obj)
            ...
            if obj.bEmailReport
                try
                    load(obj.chEmailAuthFile);
                    
                    setpref('Internet', 'E_mail', obj.chEmailSender);
                    setpref('Internet', 'SMTP_Server', obj.chEmailServer);
                    setpref('Internet','SMTP_Username', chSMTPUsername);
                    setpref('Internet','SMTP_Password', chSMTPPassword);
        ...
        function LoadAndSetExperimentSettingsFile(obj, NameValueArgs)
            ...
            if isfield(NameValueArgs, 'EmailAuthFile')
                obj.chEmailAuthFile = char(NameValueArgs.EmailAuthFile);
            elseif isfield(stSettingsFromFile, 'EmailAuthFile')
                obj.chEmailAuthFile = char(stSettingsFromFile.EmailAuthFile);
            end

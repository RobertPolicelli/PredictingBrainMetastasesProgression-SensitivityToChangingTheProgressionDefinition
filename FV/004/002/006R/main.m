...
oFV = ExperimentManager.Load('FV-004-002-006A');
...
oRecord = CustomFeatureExtractionRecord("FV-004-002-006R", oFeatureValues.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), oFeatureValues.GetFeatures());
...
oFV = ExperimentFeatureValues("FV-004-002-006R");

...
oFV = ExperimentManager.Load('FV-004-002-007A');
...
oRecord = CustomFeatureExtractionRecord("FV-004-002-007R", oFeatureValues.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), oFeatureValues.GetFeatures());
...
oFV = ExperimentFeatureValues("FV-004-002-007R");

...
oFV = ExperimentManager.Load('FV-004-002-009A');
...
oRecord = CustomFeatureExtractionRecord("FV-004-002-009R", oFeatureValues.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), oFeatureValues.GetFeatures());
...
oFV = ExperimentFeatureValues("FV-004-002-009R");

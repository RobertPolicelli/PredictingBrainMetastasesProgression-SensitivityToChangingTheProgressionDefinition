...
oLBL = ExperimentManager.Load('LBL-002-003-009');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-009R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

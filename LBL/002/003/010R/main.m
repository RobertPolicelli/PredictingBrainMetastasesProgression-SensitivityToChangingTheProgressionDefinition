...
oLBL = ExperimentManager.Load('LBL-002-003-010');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-010R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

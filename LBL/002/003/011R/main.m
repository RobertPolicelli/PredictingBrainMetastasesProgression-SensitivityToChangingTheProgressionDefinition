...
oLBL = ExperimentManager.Load('LBL-002-003-011');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-011R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

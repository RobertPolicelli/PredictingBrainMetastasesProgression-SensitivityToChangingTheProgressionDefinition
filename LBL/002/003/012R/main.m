...
oLBL = ExperimentManager.Load('LBL-002-003-012');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-012R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

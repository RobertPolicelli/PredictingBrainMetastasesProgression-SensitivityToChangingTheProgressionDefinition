...
oLBL = ExperimentManager.Load('LBL-002-003-013');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-013R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

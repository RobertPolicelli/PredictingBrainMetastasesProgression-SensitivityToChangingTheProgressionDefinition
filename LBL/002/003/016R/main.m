...
oLBL = ExperimentManager.Load('LBL-002-003-016');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-016R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

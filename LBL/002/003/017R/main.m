...
oLBL = ExperimentManager.Load('LBL-002-003-017');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-017R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

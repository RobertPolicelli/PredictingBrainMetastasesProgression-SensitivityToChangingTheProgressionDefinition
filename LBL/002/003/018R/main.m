...
oLBL = ExperimentManager.Load('LBL-002-003-018');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-018R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

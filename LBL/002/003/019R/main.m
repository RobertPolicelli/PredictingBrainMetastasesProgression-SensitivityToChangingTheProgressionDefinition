...
oLBL = ExperimentManager.Load('LBL-002-003-019');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-019R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

...
oLBL = ExperimentManager.Load('LBL-002-003-020');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-003-020R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

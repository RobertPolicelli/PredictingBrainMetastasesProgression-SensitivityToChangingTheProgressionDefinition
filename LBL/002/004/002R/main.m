...
oLBL = ExperimentManager.Load('LBL-002-004-002');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-002R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

...
[vbIsProgressionPerSample, vbIsRadionecrosisPerSample, vbIsAdverseRadiationEffectPerSample] = FileIOUtils.LoadMatFile(...
    fullfile(ExperimentManager.GetPathToExperimentAssetResultsDirectory('AYS-004-002-003'), '01 Analysis', 'Outcomes Per Sample.mat'),...
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-003", "In-field Progression", m2dFeatures);

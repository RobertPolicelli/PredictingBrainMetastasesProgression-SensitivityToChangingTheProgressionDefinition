...
oLBL = ExperimentManager.Load('LBL-002-004-008');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-008R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

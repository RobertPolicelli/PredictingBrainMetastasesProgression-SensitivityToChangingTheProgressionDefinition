...
oLBL = ExperimentManager.Load('LBL-002-004-009');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-009R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

...
oLBL = ExperimentManager.Load('LBL-002-004-016');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-016R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

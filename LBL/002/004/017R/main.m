...
oLBL = ExperimentManager.Load('LBL-002-004-017');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-017R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

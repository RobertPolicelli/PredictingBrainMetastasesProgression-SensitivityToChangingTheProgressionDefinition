...
oLBL = ExperimentManager.Load('LBL-002-004-018');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-018R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

...
oLBL = ExperimentManager.Load('LBL-002-004-019');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-004-019R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

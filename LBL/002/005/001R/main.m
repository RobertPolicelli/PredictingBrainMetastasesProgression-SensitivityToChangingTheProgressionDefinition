...
oLBL = ExperimentManager.Load('LBL-002-005-001');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-001R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

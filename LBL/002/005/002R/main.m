...
oLBL = ExperimentManager.Load('LBL-002-005-002');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-002R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

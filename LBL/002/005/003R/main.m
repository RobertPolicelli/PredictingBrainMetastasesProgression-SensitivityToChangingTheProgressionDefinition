...
oLBL = ExperimentManager.Load('LBL-002-005-003');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-003R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

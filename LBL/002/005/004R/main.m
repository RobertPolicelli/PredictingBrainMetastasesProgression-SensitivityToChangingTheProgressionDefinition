...
oLBL = ExperimentManager.Load('LBL-002-005-004');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-004R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

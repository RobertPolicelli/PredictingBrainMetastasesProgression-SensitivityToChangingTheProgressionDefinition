...
oLBL = ExperimentManager.Load('LBL-002-005-006');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-006R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

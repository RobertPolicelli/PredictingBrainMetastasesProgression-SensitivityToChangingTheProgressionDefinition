...
oLBL = ExperimentManager.Load('LBL-002-005-007');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-007R", "In-field Progression", oLabelledFeatureValues.GetFeatures());

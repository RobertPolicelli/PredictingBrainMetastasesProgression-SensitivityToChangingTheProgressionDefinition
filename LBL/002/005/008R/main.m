...
oLBL = ExperimentManager.Load('LBL-002-005-008');
...
oRecord = CustomFeatureExtractionRecord("LBL-002-005-008R", "In-field Progression", oLabelledFeatureValues.GetFeatures());
